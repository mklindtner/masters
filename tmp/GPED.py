...
#4 rows for student and teacher weights
...
w_teacher, w_student = posterior_expectation_distillation(algo_teacher=algo2D, algo_student=algo_student_reg, theta_init=w_MAP, phi_init=w_MAP, reg=None, alphas = None, criterion=loss, opt=adam, T=1000)
